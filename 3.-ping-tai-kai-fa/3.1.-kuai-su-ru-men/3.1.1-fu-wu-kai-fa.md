...
```java
@ConditionalOnProperty(value = SampleAppSvc.SVC_NAME + ".enabled", matchIfMissing = false)
@Component(SampleAppSvc.SVC_NAME)
...
<assembly xmlns="http://maven.apache.org/plugins/maven-assembly-plugin/assembly/1.1.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <fileSets>
        ...
        <fileSet>
            ...
            <outputDirectory>./skynetboot/lib</outputDirectory>
            <includes>
                <include>*.jar</include>
            </includes>
            <excludes>
